...
(function () {
    ...
    */
    ...
    console.log( 'O resultado da soma é:', sum((n1, n2) => {
       return n1 + n2;
    }));
    ...
    */
    ...
    console.log( 'O resultado da subtração é:', subtraction((n1,n2) => {
        return n1 - n2;
    }));

    console.log( 'O resultado da multiplicação é:', multiplication((n1,n2) => {
        return n1 * n2;
    }));

    console.log( 'O resultado da divisão é:', division((n1,n2) => {
        return n1 / n2;
    }));

    console.log( 'O resto da divisão é:', mod((n1,n2) => {
        return n1 % n2;
    }));
})();